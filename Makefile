...
SRCS		= 	add_env.c add_env_2.c builtins.c \
				env_pars.c free.c main.c \
				prompt.c set_history.c signal.c \
				welcome.c test.c \
...
BUILTIN		=	cd.c echo.c env.c \
				...
				unset.c
PARSER		=	dollar.c double_quotes.c exec.c \
				line.c line_2.c param.c \
				path.c pre_parse.c search_var.c \
				single_quote.c wildcard.c 
TREE		=	bt_create_node_2.c bt_create_node.c bt_create.c \
				bt_test_sep_2.c bt_test_sep.c bt_write_cmd.c
